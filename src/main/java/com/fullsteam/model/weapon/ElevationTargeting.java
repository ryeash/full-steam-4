...
public enum ElevationTargeting {
    ...
    /**
     * Get the maximum elevation this weapon can target.
     * @return The highest elevation this weapon can reach
     */
    public Elevation getMaxTargetableElevation() {
        return switch (this) {
            case GROUND_ONLY -> Elevation.GROUND;
            case GROUND_AND_LOW -> Elevation.LOW;
            case ALL_ELEVATIONS -> Elevation.HIGH;
        };
    }
}
